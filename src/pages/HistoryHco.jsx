...
const HistoryHco = () => {
  return (
    <>
      <Head
        image={`/images/Turismo/huamachuco/batallahco.jpg`}
      />
      <Layout>
        <div className='mt-8'>
          <h2>UN POCO ACERCA DE HUAMACHUCO</h2>
          <div className='mt-6 flex flex-col gap-4 items-center justify-center md:flex-row md:gap-8'>
            <div className='w-full'>
              <img
                src="/images/Turismo/huamachuco/hco1.jpg"
      ...
      <div className='bg-white pt-4 pb-16 mt-8'>
        <Layout>
          <section className='mt-8'>
            <h2>HIJOS ILUSTRES DE HUAMACHUCO</h2>
            <div className='grid grid-cols-1 w-full justify-center items-center mt-6 gap-6 xl:grid-cols-2'>
              <article className='flex flex-col w-full h-full justify-center items-center gap-4 border rounded-2xl border-slate-400 md:flex-row md:max-h-80 lg:max-h-60 xl:max-h-80'>
      ...
      <Layout>
        <section className='mt-8 md:mt-16'>
          <h2>BATALLA DE HUAMACHUCO</h2>
          <div className='mt-6 flex flex-col gap-4 justify-center items-center md:flex-row md:gap-8'>
            <div className='w-full'>
              <img src="/images/Turismo/huamachuco/batallahco.jpg" alt="Batalla de Huamachuco" className='w-full h-56 object-cover bg-center bg-cover rounded-2xl md:h-80' />
            </div>
            <div className='w-full'>
